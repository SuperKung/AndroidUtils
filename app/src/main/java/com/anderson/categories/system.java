...
public class system {
    ...
    public static String getApplicationHashKey(String packageName) {
        ...
        String hash = "";
        try {
            PackageInfo info = AndroidUtils.getContext().getPackageManager().getPackageInfo(packageName, PackageManager.GET_SIGNATURES);
            ...
            AndroidUtils.log.e("NameNotFoundException");
        } catch (NoSuchAlgorithmException e) {
            AndroidUtils.log.e("NoSuchAlgorithmException");
    ...
    public static void vibrate(int duration) {
        Vibrator v = (Vibrator) AndroidUtils.getContext().getSystemService(Context.VIBRATOR_SERVICE);
        v.vibrate(duration);
    }
    ...
    public static void toast(String message) {
        ...
        Toast toast = Toast.makeText(AndroidUtils.getContext(), message, Toast.LENGTH_SHORT);
        toast.show();
    }
    ...
    public static void toast(String message, int duration) {
        ...
        Toast toast = Toast.makeText(AndroidUtils.getContext(), message, duration);
        toast.show();
    }
    ...
    public static String getDeviceID() {
        return Settings.Secure.getString(AndroidUtils.getContext().getContentResolver(), Settings.Secure.ANDROID_ID);
    }
    ...
    public static void toggleKeyboard() {
        InputMethodManager imm = ((InputMethodManager) AndroidUtils.getContext().getSystemService(Context.INPUT_METHOD_SERVICE));
    ...
    public static boolean isServiceRunning(Class<? extends Service> service) {
        ActivityManager manager = (ActivityManager) AndroidUtils.getContext().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public static String getApplicationNameByContext() {
        final PackageManager pm = AndroidUtils.getContext().getPackageManager();
        ApplicationInfo ai;
        try {
            ai = pm.getApplicationInfo(AndroidUtils.getContext().getPackageName(), 0);
    ...
    public static void hideSoftInput(View view) {
        ((InputMethodManager) AndroidUtils.getContext().getSystemService(Context.INPUT_METHOD_SERVICE)).hideSoftInputFromWindow(
    ...
    public static String getNetworkOperatorName() {
        TelephonyManager manager = (TelephonyManager) AndroidUtils.getContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static Integer getHeapSize() {
        return ((ActivityManager) AndroidUtils.getContext().getSystemService(Context.ACTIVITY_SERVICE)).getMemoryClass();
    }
    ...
    public static String getMacAddress() {
        WifiManager wimanager = (WifiManager) AndroidUtils.getContext().getSystemService(Context.WIFI_SERVICE);
    ...
    public static boolean isIntentAvailable(Intent intent) {
        List<ResolveInfo> list = AndroidUtils.getContext().getPackageManager().queryIntentActivities(intent,
